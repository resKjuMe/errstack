...
|
| Nicht hier steht die Alarm-Übersicht: auf ihr wird nachgesehen und nicht
| eingerichtet — sie bleibt bei den Fachseiten in routes/projects.php.
|
*/
...
Route::prefix('organisationen/{organization}/projekte')
    ...
    ->group(function () {
        ...
        // selbst entstehen aus den eingehenden Meldungen. Sie stehen auf der
        // Stammdatenseite des Projekts und haben deshalb keinen eigenen
        // Eintrag in der Unter-Navigation.
        ...
        // Erkennung von Leistungsproblemen: welche Muster gelten und ab
        // wann. Ansehen darf jedes Mitglied, geändert wird sie von der
        // Verwaltung.
