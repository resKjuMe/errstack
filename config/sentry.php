...
return [
    ...
    // Wohin Errstack seine **eigenen** Fehler meldet: der DSN eines Projekts in
    // einer Errstack-Installation — der eigenen oder besser einer zweiten.
    //
    // Eigener Name statt `SENTRY_LARAVEL_DSN`, weil hier keine Sentry-Cloud
    // gemeint ist, sondern das Werkzeug selbst. Bleibt er leer, schickt das SDK
    // nichts; das ist der Auslieferungszustand und kein Fehler.
    //
    // @see https://docs.sentry.io/concepts/key-terms/dsn-explainer/
    'dsn' => env('ERRSTACK_DSN'),
    ...
    'ignore_transactions' => [
        ...
        // Die Datenaufnahme meldet sich nicht selbst. Zeigt der DSN auf die
        // eigene Installation, erzeugte sonst jede eingehende Meldung eine
        // Transaktion, die als HTTP-Aufruf wieder in der Datenaufnahme landet
        // und die nächste erzeugt — eine Lawine, die sich selbst nährt. Bei
        // abgeschaltetem Tracing (Auslieferungszustand) fällt das nicht auf;
        // beim ersten Einschalten wäre es sofort da.
        //
        // Die Namen sind die Routen-Adressen mit vorangestelltem Schrägstrich,
